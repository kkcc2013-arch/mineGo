...
- 当前需求：126/10000
- 剩余需求：9874 条
- 最新生成：REQ-00127（用户数据删除请求管理系统，合规/隐私）
- 最新完成：REQ-00126（user-service MFA 路由挂载与集成，集成与修复）
...
- **优先级**: P0
- **状态**: new
- **影响**: 解锁 REQ-00073（玩家对战系统 PVP Duel）的全部功能，13+ 个端点立即可用
- **关键特性**:
  - 挂载 pvp.js 路由到 /pvp 路径
  - 解锁匹配队列、对战房间、战斗执行等核心功能
  - 解锁 ELO 排名、战斗历史、赛季奖励等辅助功能
  - 无需额外开发，仅挂载即可使用

...
|------|------|------|--------|------|----------|----------|
| REQ-00439 | 熔断器事件告警系统集成 | 技术债/重构 | P1 | done | gateway/shared/alerting | 2026-07-06 09:00 |
| REQ-00438 | API调用示例库与最佳实践文档系统 | 文档/开发者体验 | P1 | new | backend/docs/examples | 2026-07-06 08:17 |

...
| REQ-00052 | 静态资源 CDN 集成与图片优化系统 | 性能优化 | P1 | new | game-client、gateway、infrastructure/k8s、backend/shared | 2026-06-09 14:05 |
...
|| REQ-00054 | 道馆战斗系统 | 功能增强 | P0 | new | gym-service、pokemon-service、user-service、gateway、game-client、database/migrations | 2026-06-09 16:00 ||
|
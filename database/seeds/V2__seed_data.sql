...
(55, '哥达鸭',  'Golduck',   'WATER', NULL,  'UNCOMMON',191,163,190, 0.12,0.06, NULL,NULL,ARRAY['WATER'],     '/sprites/55.png', '游泳速度极快，能在湍急的水流中自如前进'),
(74, '小拳石',  'Geodude',   'ROCK', 'GROUND','COMMON', 132,132,120, 0.40,0.12, 25, 75, ARRAY['MOUNTAIN'],    '/sprites/74.png', '半埋在地里，常被误踢而大发雷霆'),
(75, '隆隆石',  'Graveler',  'ROCK', 'GROUND','UNCOMMON',164,164,146, 0.20,0.07, NULL,NULL,ARRAY['MOUNTAIN'],  '/sprites/75.png', '沿着山路滚动前进，不在意途中撞到什么'),
(79, '呆呆兽',  'Slowpoke',  'WATER','PSYCHIC','COMMON',109,98, 207, 0.40,0.10, 50, 80, ARRAY['WATER'],       '/sprites/79.png', '反应极慢，被咬了几秒后才知道'),
(80, '呆壳兽',  'Slowbro',   'WATER','PSYCHIC','UNCOMMON',177,180,216, 0.16,0.06, NULL,NULL,ARRAY['WATER'],   '/sprites/80.png', '尾巴被大舌贝咬住后进化而成'),

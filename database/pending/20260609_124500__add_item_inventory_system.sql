...
-- 创建唯一约束（允许同一道具多个堆叠）
CREATE UNIQUE INDEX idx_player_inventory_user_item_slot 
...
CREATE INDEX idx_shop_items_active ON shop_items(item_id, is_active);
...
GROUP BY u.id, u.username, ic.base_capacity, ic.pokeball_slots, ic.potion_slots,
...
VALUES ('20260609_124500', 'Add item inventory system for REQ-00047');
